...
import { vehicleOpenOne, vehicleUpload } from "../action/vehicle";
...
const Sell = () => {
  ...
  useEffect(() => {
    ...
    // dispatch(vehicleOpenOne({ id }))
    //   .then((res) => {
    //     if (res.status === "success") {
    //       let vehicle = res.vehicle[0];
    ...
    //       setLoading(vehicle.loading);
    //       setPayMethod(vehicle.payMethod);
    //       setVehicleInfo(vehicle.vehicleInfo);
    //     }
    //     else {
    //       console.log(res.status);
    //       toast.info("You can upload the information of your vehicle", {
    //         position: "bottom-right",
    //         autoClose: 5000,
    //         hideProgressBar: true,
    //         closeOnClick: true,
          ...
          <div className="md:grid md:grid-cols-4 gap-4 w-10/12 lg:mr-14">
            ...
            <div className="border-gray-600 border-[1px] lg:-mr-4 flex flex-col items-center lg:mt-0 lg:ml-0 mb-4">
              ...
              <div className="flex justify-evenly w-full">
                <a href="#">
                  <img
                    className="w-[80px] h-[80px] cursor-pointer hover:scale-105 transition-all duration-200"
                    src="tomas2.png"
                    alt="tomas2"
                  />
                </a>
