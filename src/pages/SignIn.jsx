...
const SignIn = () => {
  ...
  return (
    <>
      ...
      />
      <div className="bg-[url('./wallpaper.png')] relative w-screen h-screen py-4 bg-no-repeat bg-cover bg-center flex justify-center items-center">
        <ToastContainer
          position="bottom-right"
          autoClose={5000}
          hideProgressBar
          ...
          theme="colored"
        />
        {/* <div className="bg-white/[0.6] w-full h-[650px] max-w-[400px] max-h-screen px-4 flex flex-col justify-around items-center rounded-lg"> */}
        <div className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 bg-white/[0.6] w-full h-[650px] max-w-[400px] max-h-screen px-4 flex flex-col justify-around items-center rounded-lg">
